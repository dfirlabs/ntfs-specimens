...
rem Create a fixed-size VHD image with a NTFS file system and 100 files
set unitsize=4096
set imagename=ntfs_100_files.vhd
set imagesize=8
...
rem Create a fixed-size VHD image with a NTFS file system and 100 alternative data streams (ADS)
set unitsize=4096
set imagename=ntfs_100_ads.vhd
set imagesize=8
