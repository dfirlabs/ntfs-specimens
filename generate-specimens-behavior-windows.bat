...
del /f /q x:\testdir3\hardlink2;
del /f /q x:\testdir5\hardlink4;
del /f /q x:\testdir7\hardlink6;
del /f /q x:\testdir9\hardlink8;
del /f /q x:\testdir11\hardlink10;
del /f /q x:\testdir13\hardlink12;
del /f /q x:\testdir15\hardlink14;
