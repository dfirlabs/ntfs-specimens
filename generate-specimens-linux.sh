...
# Create an NTFS file system without ADS support (streams_interface=windows)
...
# Create an NTFS file system with many files
SECTOR_SIZE=512;
...
# Create an NTFS file system with several corrupted files.
